...
public class WarehousePurchaseOrderLineGui extends JFrame {
	...
	String shelf1;
	String shelf2;
	String porousedShelf1;
	String porousedShelf2;
	int shelf1Qty;
	int shelf2Qty;
	int porousShelf1Qty;
	int porousShelf2Qty;
	...
	JLabel quantityLabelValue;

	JLabel qtyToPorousLabel;
	JLabel qtyToPorousLabelvalue ;

	JLabel shelvedLabel;
	JLabel shelvedLabelvalue;

	JLabel shelf1Label;
	JLabel shelf1LabelLabelvalue;

	JLabel shelf2Label;
	JLabel shelf2LabelLabelvalue;

	JLabel porousedShelf1Label;
	JLabel porousedShelf1Labelvalue;

	JLabel porousedShelf2Label;
	JLabel porousedShelf2Labelvalue;

	JLabel notesLabel;
	JLabel notesLabelValue;
	...
	// Constructor
	public WarehousePurchaseOrderLineGui(int orderNumID) {
	...
	private void prepareGUI() {
		mainFrame = new JFrame("Purchase Order Line");
		...
		customerOrderLabel = new JLabel("Purchase Order Line");
		...
		quantityLabel = new JLabel("Total Quantity:");
		quantityLabelValue = new JLabel("" + qty);

		qtyToPorousLabel = new JLabel("Quantity To Porous:");
		qtyToPorousLabelvalue = new JLabel("" + porousQty);

		shelvedLabel = new JLabel("Shelved: ");
		shelvedLabelvalue = new JLabel(shelved);

		shelf1Label = new JLabel("Non-poroused Shelf " + shelf1 + " quantity: ");
		shelf1LabelLabelvalue = new JLabel("" + shelf1Qty);

		shelf2Label = new JLabel("Non-poroused Shelf " + shelf2 + " quantity: ");
		shelf2LabelLabelvalue = new JLabel("" + shelf2Qty);

		porousedShelf1Label = new JLabel("Poroused Shelf " + porousedShelf1
				+ " quantity: ");
		porousedShelf1Labelvalue = new JLabel("" + porousShelf1Qty);

		porousedShelf2Label = new JLabel("Poroused Shelf " + porousedShelf2
				+ " quantity: ");
		porousedShelf2Labelvalue = new JLabel("" + porousShelf2Qty);

		notesLabel = new JLabel("Notes: ");
		notesLabelValue = new JLabel(notes);
		...
		mainFrame.add(quantityLabelValue);

		mainFrame.add(qtyToPorousLabel);
		mainFrame.add(qtyToPorousLabelvalue);

		mainFrame.add(shelvedLabel);
		mainFrame.add(shelvedLabelvalue);

		mainFrame.add(shelf1Label);
		mainFrame.add(shelf1LabelLabelvalue);

		mainFrame.add(shelf2Label);
		mainFrame.add(shelf2LabelLabelvalue);

		mainFrame.add(porousedShelf1Label);
		mainFrame.add(porousedShelf1Labelvalue);

		mainFrame.add(porousedShelf2Label);
		mainFrame.add(porousedShelf2Labelvalue);

		mainFrame.add(notesLabel);
		mainFrame.add(notesLabelValue);
	...
	public static void main(String[] args) {
		...
		//WarehousePurchaseOrderLineGui sD = new WarehousePurchaseOrderLineGui(1);
		 //sD.showEvent();
		// sD.getOrderLines(1);
		// sD.readDBvalues(3);
		// sD.updateGUI();
